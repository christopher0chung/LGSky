...
#pragma warning restore 0649
        ...
        /// <summary>
        /// Stop the currently playing <see cref="IntroloopAudio"> and unload it from memory.
        /// </summary>
        /// <param name="fadeLengthSeconds">Fade out length to use in seconds. If 0, it uses a small pop removal fade time. If negative, it stops immediately. The audio will be unloaded only after it had fade out completely.</param>
        public void Stop(float fadeLengthSeconds = 0)
        {
        ...
        /// <summary>
        /// Pause the currently playing <see cref="IntroloopAudio"> without unloading,
        ...
        public void Pause(float fadeLengthSeconds = 0)
        {
