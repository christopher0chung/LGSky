...
Shader "RadialTransparency"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			clip( (_BandMin + (sin( ( ( atan2( ase_vertex3Pos.x , ase_vertex3Pos.y ) * _RadialScalar ) + mulTime12 ) ) - -1.0) * (_BandMax - _BandMin) / (1.0 - -1.0)) - _Cutoff );
		}
...
/*ASEBEGIN
Version=17101
819;98;979;931;1921.954;-29.99152;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1445.954,654.9915;Inherit;False;Property;_SpeedScalar;Speed Scalar;2;0;Create;True;0;0;False;0;0;25;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=8E390A1435B2F715B6EBD767F1C7822D5F949FC8